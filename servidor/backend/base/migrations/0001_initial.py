    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(upload_to='group_covers/')),
            ],
        ),
        migrations.CreateModel(
            name='Groups',
            fields=[
                ...
                ('cover_image', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='base.coverimage')),
